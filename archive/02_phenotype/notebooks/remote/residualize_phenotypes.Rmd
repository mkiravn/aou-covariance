...
ANCESTRY_BUCKET_DIR <- file.path(WORKSPACE_BUCKET, CDR_VERSION, "01_ancestry_filtering")
PHENOTYPE_BUCKET_DIR <- file.path(WORKSPACE_BUCKET, CDR_VERSION, "02_phenotype")
